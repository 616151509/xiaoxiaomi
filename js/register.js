    ...
    return {
        ...
        event: function() {
            ...
            this.$loginBtn.onclick = function() {
                ...
                sendAjax('http://localhost:777/xiaomi/php/register.php', params);
            },
            // 判断用户名称是否存在
            this.$usernameInp. addEventListener('change', function(){
                ...
                sendAjax('http://localhost:777/xiaomi/php/check_username.php', params);
            }, false);
        },
        ...
        register: function(data) {
            if(data.code == 200) {
                //   注册成功
                location.href = '../xiaomi/xiaomi.html';
